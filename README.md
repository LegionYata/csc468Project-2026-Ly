...
- WORKDIR /app
Sets "/ap[" as the main working directory within the container. All other components in the Dockerfile operates relative to this path. In order to keep the container's filestystem neat and clean.
